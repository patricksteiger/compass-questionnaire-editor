<template>
            ...
            >
              <div class="row">
                ...
                <q-btn
                  ...
                  @click="
                    () => {
                      enableWhenInfoLayout = true;
                    }
                  "
                >
                  <cxTooltip :text="$t('tutorial.enableWhenInfo')" />
                </q-btn>
                <!-- enableWhen behavior -->
                <q-select
                  class="col-4"
  ...
  <q-dialog v-model="enableWhenInfoLayout">
    <q-card>
      <q-card-section class="row items-center">
        <q-avatar icon="info" color="blue" text-color="white" />
        <span class="q-pa-md text-bold"> General information </span>
        <span class="q-pa-xs">
          EnableWhen contains conditions, based on answers to other questions.
          If they are met the question is enabled, otherwise it is disabled. If
          EnableWhen is empty, the question is enabled by default. The
          child-items of a disabled question are also disabled.
        </span>
        <span class="q-pa-xs">
        ...
        <span class="q-pa-xs">
          ...
          is set to protected, they are not interactable. If it isn't present,
          it is up to the application rendering the questionnaire.
        </span>
        <span class="q-pa-xs text-bold"> EnableBehavior </span>
        <span class="q-pa-xs">
          EnableBehavior indicates whether all or at least 1 condition have to
          be met for the question to be enabled.
        </span>
        ...
        <span class="q-pa-xs">
          If the linked question is of type "integer", Operator is set to "="
          and Answer is "10", then this question is disabled until the linked
          question is answered with "10".
        </span>
        <span class="q-pa-xs">
          ...
          collected answer. If Answer is set to "true", the linked question has
          to be answered with any value for this question to be enabled. If
          Answer is set to "false", this question is enabled as long as the
          linked question is not answered with any value.
        </span>
      </q-card-section>
      <q-card-actions align="right">
        <q-btn
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      enableWhenInfoLayout: ref(false),
      comparators,
      chosenEnableWhen,
      linkedItem,
      noChoiceItemTypeIcons,
